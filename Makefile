...
SRCS = src/main.c src/util/util.c src/prox/prox.c src/scan/scan.c src/atlas/sub.c\
       src/deepblue/deepblue.c src/ghostquery/gq.c src/chrome/chrome.c src/glassworm/gw.c \
